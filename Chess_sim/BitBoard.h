...
public:
	BitBoard() : board(0) {}
	BitBoard(uint64_t value) : board(value){}
...
namespace BitBoardRows
{
	...
	extern std::array<BitBoard, 8> Rows;
	extern std::array<BitBoard, 8> InversionRows;
}
...
namespace BitBoardColumns
{
	...
	extern std::array<BitBoard, 8> Columns;
	extern std::array<BitBoard, 8> InversionColumns;
}
